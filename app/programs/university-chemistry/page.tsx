...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/university-chemistry",
  );
}
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  ...
                  while solving numerical problems and completing lab work.
                  Master difficult chemistry concepts with structured support
                  for coursework, labs, and exams.
                </p>
              </div>
