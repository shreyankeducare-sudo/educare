...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/chemistry",
  );
}
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  ...
                  understanding and practical application. From chemical
                  reactions and formulas to lab reports and calculations,
                  students often struggle to balance theory with
                  problem-solving.
                </p>
                <p>
                  At Dr. Shreyank Educare, we provide structured tutoring that
                  helps students understand difficult concepts, improve
                  analytical thinking, and perform better in coursework, labs,
                  and exams.
                </p>
              </div>
