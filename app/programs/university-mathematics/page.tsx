...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/university-mathematics",
  );
}
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  ...
                  mathematical modeling, students often struggle to keep pace
                  with lectures and assignments.
                </p>
                <p>
                  At Dr. Shreyank Educare, we simplify complex mathematical
                  concepts through personalized instruction, step-by-step
                  problem solving, and focused academic support.
                </p>
              </div>
