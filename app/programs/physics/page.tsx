...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/physics",
  );
}
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  ...
                  while applying advanced mathematical concepts to solve
                  problems.
                </p>
                <p>
                  At Dr. Shreyank Educare, we help students break down difficult
                  physics topics into simpler concepts and develop the
                  analytical skills needed to solve physics problems with
                  confidence. Our structured approach ensures students improve
                  both their understanding of physics theory and the mathematics
                  behind it.
                </p>
              </div>
