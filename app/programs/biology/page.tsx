...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/biology",
  );
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 mt-10 items-start">
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  University biology becomes challenging when students rely
                  solely on memorization. We help students understand biological
                  systems, relationships, and scientific reasoning to master the
                  subject effectively.
                </p>
                <p>
                  Whether you're preparing for nursing school, pre-med, or a
                  biology major, our tutors provide the conceptual clarity and
                  lab support needed to excel in your coursework and exams.
                </p>
              </div>
