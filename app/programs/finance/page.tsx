...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/finance",
  );
}
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                ...
                <p>
                  ...
                  Whether you're pursuing university coursework or preparing for
                  professional certifications, our programs are built to help
                  you succeed.
                </p>
              </div>
