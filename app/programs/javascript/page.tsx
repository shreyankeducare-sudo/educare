...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/javascript",
  );
}
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                ...
                <p>
                  ...
                  experimenting with code, and understanding how programming
                  works in real-world applications like websites, games, and
                  software systems.
                </p>
              </div>
