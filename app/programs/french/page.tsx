...
export async function generateMetadata() {
  ...
  return getMetadata(data, "https://www.drshreyankeducare.com/programs/french");
}
...
export default async function FrenchCoursePage() {
  const data = await getMetaDataBySlug("programPage", "french");
    ...
    <>
      <JsonLd
        schema={getPageSchema(
          data,
          "https://www.drshreyankeducare.com/programs/french",
        )}
      />
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  ...
                  an important skill for academics, travel, careers, and
                  personal growth.
                </p>
                <p>
                  At Dr. Shreyank Educare, our French language program helps
                  learners develop strong communication skills through
                  interactive lessons, conversational practice, vocabulary
                  building, grammar training, and cultural understanding.
                </p>
              </div>
