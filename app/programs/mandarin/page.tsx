...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/mandarin",
  );
}
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  ...
                  an increasingly valuable skill for global opportunities,
                  academics, and future careers.
                </p>
                <p>
                  At Dr. Shreyank Educare, our Mandarin program helps students
                  learn the language step-by-step through pronunciation
                  training, conversational speaking, character recognition, and
