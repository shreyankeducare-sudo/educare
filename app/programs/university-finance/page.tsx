...
export async function generateMetadata() {
  ...
  return getMetadata(
    data,
    "https://www.drshreyankeducare.com/programs/university-finance",
  );
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 mt-10 items-start">
            ...
            <div>
              ...
              <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
                <p>
                  Finance requires more than understanding formulas and
                  theories—it demands analytical thinking, practical
                ...
                <p>
                  ...
                  personalized mentorship, and industry-relevant learning.
                  Whether you&apos;re pursuing university coursework or
                  preparing for professional certifications, our programs are
          ...
          <section className="mt-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-bg-grey p-8 rounded-[8px] shadow-[0_10px_50px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_70px_rgba(0,0,0,0.08)] transition-all duration-500 hover:-translate-y-2 group">
                ...
                <ul className="space-y-2">
                  <p className="text-[12px] font-bold text-slate/40 mb-2 uppercase tracking-wider">
                    CFA Levels I, II & III
                  </p>
                  {[
                    "Ethics",
