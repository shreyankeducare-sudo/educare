...
export async function generateMetadata() {
  ...
  return getMetadata(data, "https://drshreyankeducare.com/programs/university-biology");
}
...
export default async function UniversityBiologyPage() {
  ...
  return (
    <>
      <JsonLd schema={getPageSchema(data, "https://drshreyankeducare.com/programs/university-biology")} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 mt-10 items-start">
          ...
          <div>
            ...
            <div className="space-y-4 text-[16px] leading-[22px] font-montserrat text-slate mb-6">
              <p>
                Biology is more than memorizing definitions and diagrams, it&apos;s
                about understanding how living systems interact and function
                together. Many students struggle because they rely heavily on
                memorization instead of true comprehension.
              </p>
              <p>
